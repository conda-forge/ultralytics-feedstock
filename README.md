...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/ultralytics-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/ultralytics-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add ultralytics
# for installing globally
pixi global install ultralytics
```
...
It is possible to list all of the versions of `ultralytics` available on your platform:
...
```
pixi search ultralytics --channel conda-forge
```
